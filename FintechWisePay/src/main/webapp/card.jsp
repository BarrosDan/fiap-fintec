...
<body>
  ...
  <section class="main-content">
    <p style="text-align: center;">PAGUE COM O CARTÃO DE CRÉDITO.<br><br>É RÁPIDO E SIMPLES.</p>
    <form action="card" method="POST" class="inputs">
	    ...
	    <input class="sign-up" type="submit" value="PAGAR AGORA">
	</form>
  </section>
</body>
